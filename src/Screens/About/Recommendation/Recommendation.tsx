  ...
  <Container>
    <Section>
      ...
      <ProfileContainer>
        ...
        <Message>
          HTML, CSS를 비롯해 JS는 기본적으로 학습이 선행되어야 ReactJS 강의를
          이해할 수 있기 때문에 필수 강의는 배제하고, 필수는 아니지만 수강 시
          분명한 도움을 주는 노마드코더의 강의 후기를 적어보았습니다.
        </Message>
      </ProfileContainer>
      <Base.GradientLine />
    </Section>
    ...
    <Section>
      ...
      <ProfileContainer>
        ...
        <Message>
          ...
          함수형 컴포넌트로 작성하였습니다. 6개월 전만해도 저는 개발자가
          아니었기 때문에 Class 컴포넌트 형식으로 개발을 해본 경험도 없을뿐더러
          일부러 옛스타일을 따라가고 싶진 않았습니다. 니꼬 선생님의 말처럼
          섹시한 코딩 스타일을 원했기 때문에 ES6의 섹시한 문법들을 사용하고
          있습니다. 때문에 자연스럽게 useState, useEffect와 같은 Hooks를
          사용하게 되는데, 스스로 이러한 Hooks를 커스텀하게 작성하기 위해서는
          도움이 되는 강의라고 할 수 있습니다. 물론 기제공되는 Hooks도 제대로
          사용하기 어려운데, 스스로 만들어 사용한다는 것은 지금도 어렵습니다.
          하지만 NICOFLIX에서는 어떻게든 제가 스스로 만든 Hooks를 구겨넣기 위해
          노력했습니다.
        </Message>
      </ProfileContainer>
      <Base.GradientLine />
